...
wp.customize.controlConstructor['guten-learn-section-order'] = wp.customize.Control.extend({
  ready: function ready() {
    'use strict';

    var control = this;
    jQuery('#customize-control-' + control.params.id).find('.guten-learn-sortable-section').sortable({
